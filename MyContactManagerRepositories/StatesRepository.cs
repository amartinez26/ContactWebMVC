...
namespace MyContactManagerRepositories
{
    public class StatesRepository : IStatesRepository
    {
        ...
        public async Task<IList<State>> GetAllAsync()// return all states
        {
            return await _context.States
                                .AsNoTracking() //turns off tracking back to the db context
                                .ToListAsync();
        }
        public async Task<State?> GetAsync(int id) // return a single state
        {
            return await _context.States
                                .AsNoTracking()
